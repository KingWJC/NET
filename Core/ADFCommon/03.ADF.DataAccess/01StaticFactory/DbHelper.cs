...
/*
 * @Author: KingWJC
 * @Date: 2020-06-08 09:32:58
 * @LastEditors: KingWJC
 * @LastEditTime: 2021-04-26 14:52:16
 * @Descripttion: 
 * @FilePath: \ADFCommon\03.ADF.DataAccess\01StaticFactory\DbHelper.cs
 * 
 * 静态工厂类，创建数据库操作对象，并执行其方法。
 * 
 */
    ...
    public class DbHelper
    {
            ...
            try
            {
                switch (DbTypeStrToDbType(DatabaseType))
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteScalar(strSQL);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteScalar(strSQL);
                }
            }
            catch (Exception ex)
            {
        ...
        public static int GetCount(string strSQL)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteCount(strSQL);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteCount(strSQL);
                }
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetDataTable(string strSQL,CusDbParameter[] parameters)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteDataTable(strSQL,parameters);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteDataTable(strSQL,parameters);
                }
            }
            catch (Exception ex)
            {
        ...
        public static DataSet GetDataSet(string strSQL)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteDataSet(strSQL);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteDataSet(strSQL);
                }
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetDataTablePage(string sqlSQL, int currentPage, int pageSize)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteDataTable(sqlSQL, currentPage, pageSize);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteDataTable(sqlSQL, currentPage, pageSize);
                }
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetDataTablePage(string strSQL, int pageSize, int pageCurrent, string fdShow, string fdOrder, out int totalCount)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecPageProc(strSQL, pageSize, pageCurrent, fdShow, fdOrder, out totalCount);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecPageProc(strSQL, pageSize, pageCurrent, fdShow, fdOrder, out totalCount);
                }
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetDataParal(string strSQL, List<string> wheres)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteDataTableParallel(strSQL, wheres);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteDataTableParallel(strSQL, wheres);
                }
            }
            catch (Exception ex)
            {
        ...
        public static int Modify(string strSQL)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteNonQuery(strSQL);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteNonQuery(strSQL);
                }
            }
            catch (Exception ex)
            {
        ...
        public static int Modify(Dictionary<string, CusDbParameter[]> dicts)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteNonQuery(dicts);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteNonQuery(dicts);
                }
            }
            catch (Exception ex)
            {
        ...
        public static int ModifyByTrans(string strSQL)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        return new SqlserverHelper(ConnectionString).ExecuteNonQueryUseTrans(strSQL);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteNonQueryUseTrans(strSQL);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                switch (DbTypeStrToDbType(DatabaseType))
                {
                    case DatabaseTypeEnum.SqlServer:
                        ...
                        return new SqlserverHelper(ConnectionString).ExecuteNonQueryUseTrans(dicts);
                    case DatabaseTypeEnum.Oracle:
                        return new OracleHelper(ConnectionString).ExecuteNonQueryUseTrans(dicts);
                }
            }
            catch (Exception ex)
            {
        ...
        public static void BulkCopyData(string tableName, DataTable dtCopy)
        {
            try
            {
                ...
                {
                    case DatabaseTypeEnum.SqlServer:
                        new SqlserverHelper(ConnectionString).ExecuteBulkCopy(tableName, dtCopy);
                        break;
                    case DatabaseTypeEnum.Oracle:
                        break;
                }
